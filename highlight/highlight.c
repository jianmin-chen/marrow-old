...
char *JSON_extensions[] = {".json", NULL};
char *JSON_keywords[] = {NULL};
...
char *RUST_keywords[] = {
    "as",   "use", "extern_crate", "break", "const",  "continue", "crate",
    "else", "if",  "if let",       "enum",  "extern", "fn",       "for",
    "impl", "in",  "let",          "loop",  "match",  "mod",      "move",
    "mut",  "pub", "return",       "true|", "false|", NULL};

syntax HLDB[] = {{"arson", ARSON_extensions, ARSON_keywords, "#", NULL, NULL,
                  HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
                 {"c", C_extensions, C_keywords, "//", "/*", "*/",
                  HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
                 {"json", JSON_extensions, JSON_keywords, NULL, NULL, NULL,
                  HL_HIGHLIGHT_NUMBERS | HL_HIGHLIGHT_STRINGS},
...
void loadTheme(char *name) {
    ...
    if (ini_parse(config.hlHighlightLocation, handler, &theme) < 0) {
